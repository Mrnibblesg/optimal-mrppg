...
public class MultiagentGraphSolverGurobiDistance extends GRBCallback{
	...
	protected int[][] solve(Graph graph, int starts[], int goals[], int expansion, double timeLimit) throws GRBException{
		...
		if(bDebugInfo){
			System.out.print("Trying T = " + expansion + " for the integer model " + ((timeLimit != -1)?("with max time limit " + timeLimit):"") + "...");
		}
